...
import { ShieldAlert, CheckCircle, Clock, ArrowLeft, Mail, AlertTriangle } from "lucide-react";

// Add your admin emails here. Only these emails can access this page.
      ...
      <main className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <div className="bg-[#111] border border-white/10 rounded-2xl p-6 flex items-center gap-4 shadow-lg">
            <div className="p-4 bg-blue-500/20 rounded-xl text-blue-400"><Mail className="w-8 h-8"/></div>
            <div>
              <p className="text-gray-400 text-sm font-bold uppercase tracking-widest">Total Tickets</p>
              <h3 className="text-3xl font-black text-white">{tickets.length}</h3>
            </div>
          </div>
          ...
          <div className="bg-[#111] border border-green-500/30 rounded-2xl p-6 flex items-center gap-4 shadow-[0_0_20px_rgba(34,197,94,0.1)]">
            ...
            <div>
              ...
              <h3 className="text-3xl font-black text-white">{resolvedTickets}</h3>
            </div>
          </div>
        </div>
                  ...
                  <div className="flex flex-col md:flex-row justify-between md:items-start gap-4">
                    ...
                    {ticket.status === "Open" && (
                      <button 
                        ...
                        className="bg-white text-black font-bold px-6 py-3 rounded-xl hover:bg-gray-200 transition-colors flex-shrink-0 flex items-center gap-2"
                      >
