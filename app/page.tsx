...
export default function Home() {
  ...
  return (
    <div className="bg-[#0A0A0B] min-h-screen relative text-[#EDEDED] font-sans selection:bg-blue-500/30 flex flex-col">
      ...
      <footer className="border-t border-white/5 bg-[#000] py-12 relative z-0">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-xl font-bold tracking-widest font-mono flex items-center gap-2 opacity-50">
            <Zap className="w-4 h-4"/> CLAWLINK<span className="text-blue-500">.</span>
          </div>
          <p className="text-xs text-gray-600 font-mono">
            Powered by the World's Fastest AI Routing Infrastructure. © 2026.
          </p>
        </div>
      </footer>

      {/* 🚀 MODALS (Intact Logic, Polished Look) */}
      <AnimatePresence>
        {isTelegramModalOpen && (
