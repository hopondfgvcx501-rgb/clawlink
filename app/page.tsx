...
export default function Home() {
  ...
  return (
    <div className="bg-[#111111] min-h-screen relative text-[#EDEDED] font-sans selection:bg-orange-500/30 overflow-x-hidden">
      ...
      {/* 🚀 MAIN HERO SPLIT SECTION (Canva Architecture) */}
      ...
      {/* 🚀 FOOTER */}
      <footer className="pt-24 pb-12 relative z-10 bg-[#161618]">
