...
export default function Home() {
  ...
  return (
    <div className="bg-[#0A0A0B] min-h-screen relative text-[#EDEDED] font-sans selection:bg-blue-500/30 overflow-x-hidden">
      
      {/* 🚀 1. HERO AREA (LandingUI with Model Selector Injected) */}
      <div className="relative z-10 w-full min-h-[85vh] flex flex-col justify-center">
      ...
      {/* 🚀 3. THE 5 ENTERPRISE FEATURES */}
      <section className="py-24 border-t border-white/5 bg-[#0A0A0B] relative z-0">
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-16 text-center">
            <h2 className="text-3xl md:text-5xl font-black tracking-tight mb-4 flex items-center justify-center gap-3 text-white">
              Enterprise Capabilities
            </h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">Beyond a simple chatbot. A fully autonomous support infrastructure.</p>
          </div>
